...
function Content() {
  ...
  //     className={cn(
  //       "p-4 bg-red-400 ",
  //       "bg-background border-r border-border fixed h-screen shrink-0 flex-col justify-between top-0",
  //       // "h-screen shrink-0 flex-col justify-between fixed top-0 pb-4 items-center hidden md:flex z-50 transition-all duration-200 ease-in-out",
