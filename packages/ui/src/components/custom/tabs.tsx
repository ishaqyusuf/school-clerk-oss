...
type TabContext = ReturnType<typeof createTabContext>;
export const TableContext = createContext<TabContext>(undefined);
export const TabProvider = TableContext.Provider;
...
type TabItemContext = ReturnType<typeof createTabItemContext>;
export const TabItemContext = createContext<TabItemContext>(undefined);
export const TabItemProvider = TabItemContext.Provider;
export const createTabItemContext = (props: { value? }) => {
  const tab = useTab();
  return {
