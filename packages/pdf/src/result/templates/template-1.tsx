    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.pageInner}>
        ...
        <View style={styles.metadataBlock}>
          <View style={[styles.metadataRow, { fontSize: density.metaFontSize }]}>
            <View style={styles.metadataCellWide}>
              ...
              <View style={[styles.dashedValue, styles.dashedValueWide]}>
                <Text>
                  {nameParts.length ? nameParts.join(" ") : formatResultValue("-")}
                </Text>
              </View>
            </View>
          ...
          <View style={[styles.metadataRow, { fontSize: density.metaFontSize }]}>
            ...
            <MetaPair
              ...
              value={
                report.grade?.percentage === null || report.grade?.percentage === undefined
                  ? "-"
                  : `${formatResultValue(report.grade.percentage)}%`
              }
            />
            <MetaPair label={labels.position} value={getGradePositionText(report)} />
                ...
                {table.columns.map((column, columnIndex) => {
                  ...
                  return (
                    <View
                      ...
                      style={[
                        isFirstColumn ? styles.firstColumn : styles.numericColumn,
        ...
        <View style={styles.footerWrap}>
          <View>
            <CommentRow label={`${commentLabel}:`} value={report.comment?.arabic ?? "-"} />
            <CommentRow
  ...
  return (
    <View style={styles.signatureColumn}>
      <View style={styles.signatureImageSpacer}>
        {imageSrc ? <Image src={imageSrc} style={styles.signatureImage} /> : null}
      </View>
