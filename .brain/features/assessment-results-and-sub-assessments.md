...
- Classroom result review uses the shared Midday-style search filter as its single control surface for student-name search, term selection, classroom selection, and subject multi-select, while preserving report-specific print-selection state.
