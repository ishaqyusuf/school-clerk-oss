...
- Every student in the active classroom roster receives one recording status: Present, Absent, or Late. The optional remark field appears only after Absent or Late is selected; Present students do not show or submit a remark. Illness is recorded as Absent with `Sick` in the optional remark. Existing Excused and Leave records remain readable for historical compatibility.
